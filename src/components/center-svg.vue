...
onMounted(() => {
  ...
  timeLin
    ...
    .fromTo(
      ['#center'],
      // 0%
      { duration: 1, scale: 0.7, y: 30, opacity: 0.6, transformOrigin: 'bottom' },
      // 100%
      { duration: 1, scale: 1, y: 0, opacity: 1, transformOrigin: 'bottom' },
      // 提前1s执行动画，跟上面动画异步执行
      '-=1'
    )
})
  ...
  <div class="center-svg">
    ...
    >
      ...
      <g id="dongxiao1">
        ...
        <g id="text">
          <text id="text6" class="cls-57" transform="translate(179.049 154.026) scale(0.481 0.481)">广州</text>
          <text id="text5" class="cls-57" transform="translate(63.771 351.7) scale(0.481 0.481)">深圳</text>
          <text id="text4" class="cls-57" transform="translate(161.75 622.618) scale(0.481 0.481)">东莞</text>
          <text id="text3" class="cls-57" transform="translate(583.87 649.734) scale(0.481 0.481)">珠海</text>
          <text id="text2" class="cls-57" transform="translate(719.835 441.012) scale(0.481 0.481)">中山</text>
          <text id="text1" class="cls-57" transform="translate(637.843 173.315) scale(0.481 0.481)">佛山</text>
        </g>
      </g>
    </svg>
...
#icon_pie_shenzhen {
  animation: updown 2.5s ease-in infinite;
}
@keyframes updown {
  0%,
  100% {
